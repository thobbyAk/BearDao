...
contract StakingHousev is Ownable {
    ...
    function updateRewardPerBlock(uint256 _rewardTokensPerBlock)
        public
        onlyOwner
    {
        rewardTokensPerBlock = _rewardTokensPerBlock;
    ...
    function enterStaking(uint256 _amount) public {
        ...
        staker.rewardDebt =
            (staker.amount * pool.accumulatedRewardsPerShare) /
            REWARDS_PRECISION;
        bearToken._mint(msg.sender, _amount);
    ...
    function leaveStaking(uint256 _amount) public {
        ...
        bearToken._burn(msg.sender, _amount);
    ...
    function harvestRewards(uint256 _poolId) public {
        ...
        bearToken._mint(msg.sender, rewardsToHarvest);
    }
